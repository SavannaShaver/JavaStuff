...
public class Fruit implements Comparable<Fruit> {
	...
	{
		if(aT !=null && (aT.equalsIgnoreCase("apple") ||aT.equalsIgnoreCase("banana")|| aT.equalsIgnoreCase("orange")
				||aT.equalsIgnoreCase("kiwi") ||aT.equalsIgnoreCase("tomato")))
		{
		 this.type = aT;
		}
		else
	...
	public int compareTo(Fruit aFruit)
	{
		...
		if(this.weight < aFruit.getWeight())
			...
			return this.type.compareTo(aFruit.getType()); // compares letters not nums
